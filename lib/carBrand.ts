...
export const BRAND_RULES: BrandRule[] = [
  ...
  { pattern: /벤츠|벤즈|mercedes|메르세데스|\b(?:[CES]\s?\d{3}(?:d|e|h)?|GL[ABCES]|CLA|CLS)\b/i, slug: 'mercedes-benz', label: '벤츠' },
  ...
  // 320d, 420i, 730Li, M340i처럼 시리즈명 없이 모델코드(숫자+연료/파워트레인 접미사)만 적힌 경우도 매칭
  { pattern: /\bbmw\b|\b[1-8]\s?시리즈|\bx[1-7]\b|\bm[2-8]\b|\bi[347]\b|\bix\b|\bm?[1-8]\d{2}(?:i|d|e|li|xi|si)\b/i, slug: 'bmw', label: 'BMW' },
  ...
  { pattern: /쌍용|ssangyong|kg\s?모빌리티|\bkgm\b|렉스턴|티볼리|코란도|무쏘|액티언|카이런|체어맨|토레스|필랑트/i, slug: 'ssangyong', label: 'KGM(쌍용)' },
