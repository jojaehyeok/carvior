...
// 이 페이지는 소개(info) 전용입니다 — 신청/결제는 전부 /inspection에서 진행됩니다.
...
const STEPS = [
    { num: '01', title: '평가 신청 & 결제', desc: '차량 정보와 방문 일정을 입력하고 간편 결제 (99,000원)', icon: '💳' },
        ...
        <div className="min-h-screen font-sans antialiased bg-white">
            ...
            <section className="relative overflow-hidden text-white bg-zinc-950">
                ...
                <div className="relative max-w-xl px-6 pb-0 mx-auto pt-14">
                    ...
                    <Link
                        href="/inspection"
                        className="block w-full py-4 bg-white text-zinc-900 rounded-2xl font-extrabold text-lg shadow-2xl shadow-black/40 active:scale-[0.98] transition-all mb-4 text-center"
                    >
                        평가 신청하기 →
                    </Link>
                ...
                <div className="max-w-xl mx-auto">
                    ...
                    <div className="space-y-3">
                        {[
                            ...
                            { icon: '🔒', title: '안전 결제', desc: '결제는 안전하게 처리됩니다. 영수증 자동 발급.' },
                        ].map(item => (
            ...
            <section className="px-6 py-10 bg-zinc-950">
                <div className="max-w-xl mx-auto space-y-4 text-center">
                    ...
                    <Link
                        href="/inspection"
                        className="inline-block px-10 py-4 text-base font-extrabold transition-all bg-white shadow-xl text-zinc-900 rounded-2xl active:scale-95"
                    >
                        99,000원으로 시작하기 →
                    </Link>
                </div>
            ...
            {/* ── 하단 안내 (신청은 /inspection에서) ── */}
            <section className="px-6 bg-zinc-950 py-14">
                <div className="max-w-xl mx-auto">
                    <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest text-center mb-2">EVALUATION</p>
                    <h2 className="mb-2 text-2xl font-black leading-tight text-center text-white">평가 신청하기</h2>
                    ...
                    <Link
                        href="/inspection"
                        className="block w-full py-4 bg-white text-zinc-900 rounded-2xl font-extrabold text-base tracking-wide transition-all active:scale-[0.98] shadow-xl text-center"
                    >
                        평가 신청하러 가기 →
                    </Link>
                    ...
                    <div className="pt-8 mt-8 border-t border-zinc-800">
                        <p className="mb-3 text-xs text-center text-zinc-600">신청 전 전화 문의</p>
                        <a
                            href="tel:15882285"
            ...
            <div className={clsx(
                ...
                <div className="max-w-xl mx-auto">
                    <Link
                        href="/inspection"
                        className="block w-full py-4 bg-zinc-900 text-white font-extrabold text-base rounded-2xl shadow-2xl shadow-black/50 active:scale-[0.98] transition-all border border-zinc-700 text-center"
                    >
                        평가 신청하기 →
                    </Link>
                </div>
