    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center bg-black/60 backdrop-blur-sm px-4 pb-0 sm:pb-4">
            <div className="w-full max-w-lg bg-white rounded-t-3xl sm:rounded-3xl overflow-hidden shadow-2xl max-h-[85vh] flex flex-col">
                {/* 헤더 */}
                <div className="flex items-center justify-between flex-shrink-0 px-6 py-5 border-b border-zinc-100">
                    <div>
                    ...
                    <button
                        onClick={onClose}
                        className="flex items-center justify-center w-8 h-8 text-sm font-bold transition-all rounded-full bg-zinc-100 text-zinc-500 active:scale-95"
                    >
                        ✕
                    </button>
                </div>
                ...
                <div className="px-6 py-5 space-y-6 overflow-y-auto text-sm">
                    ...
                    <section>
                        <h3 className="mb-2 font-extrabold text-zinc-900">1. 수집 및 이용 목적</h3>
                        <ul className="space-y-1 leading-relaxed text-zinc-500">
                    ...
                    <section>
                        <h3 className="mb-2 font-extrabold text-zinc-900">2. 수집하는 개인정보 항목</h3>
                        <div className="space-y-2">
                            <div className="px-4 py-3 bg-zinc-50 rounded-xl">
                                <p className="text-[10px] font-extrabold text-zinc-400 uppercase tracking-wider mb-1.5">필수 항목</p>
                                <p className="leading-relaxed text-zinc-600">차량번호, 연락처, 방문 주소, 희망 방문 일시</p>
                            </div>
                            <div className="px-4 py-3 bg-zinc-50 rounded-xl">
                                <p className="text-[10px] font-extrabold text-zinc-400 uppercase tracking-wider mb-1.5">선택 항목</p>
                                <p className="leading-relaxed text-zinc-600">희망 판매가, 차량 상세 정보</p>
                            </div>
                        </div>
                    </section>

                    <section>
                        <h3 className="mb-2 font-extrabold text-zinc-900">3. 보유 및 이용 기간</h3>
                        ...
                        <div className="px-4 py-3 mt-2 text-xs leading-relaxed bg-zinc-50 rounded-xl text-zinc-400">
                    ...
                    <section>
                        <h3 className="mb-2 font-extrabold text-zinc-900">4. 동의 거부 권리 및 불이익</h3>
                        <p className="leading-relaxed text-zinc-500">
                    ...
                    <section>
                        <h3 className="mb-2 font-extrabold text-zinc-900">5. 개인정보 처리자</h3>
                        <p className="leading-relaxed text-zinc-500">
                            상호: 카비어 <br />
                            담당자 : 조재혁 <br />
                ...
                {/* 하단 버튼 */}
                <div className="flex-shrink-0 px-6 py-4 border-t border-zinc-100">
                    <button
                        onClick={onClose}
